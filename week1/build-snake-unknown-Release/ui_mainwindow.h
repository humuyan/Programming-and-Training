...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icon/save.ico"), QSize(), QIcon::Normal, QIcon::Off);
        saveAction->setIcon(icon1);
        quitAction = new QAction(MainWindow);
        quitAction->setObjectName(QString::fromUtf8("quitAction"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icon/quit.ico"), QSize(), QIcon::Normal, QIcon::Off);
        quitAction->setIcon(icon2);
        startAction = new QAction(MainWindow);
        startAction->setObjectName(QString::fromUtf8("startAction"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icon/start.ico"), QSize(), QIcon::Normal, QIcon::Off);
        startAction->setIcon(icon3);
        pauseAction = new QAction(MainWindow);
        pauseAction->setObjectName(QString::fromUtf8("pauseAction"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icon/pause.ico"), QSize(), QIcon::Normal, QIcon::Off);
        pauseAction->setIcon(icon4);
        resumeAction = new QAction(MainWindow);
        resumeAction->setObjectName(QString::fromUtf8("resumeAction"));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icon/resume.ico"), QSize(), QIcon::Normal, QIcon::Off);
        resumeAction->setIcon(icon5);
        restartAction = new QAction(MainWindow);
        restartAction->setObjectName(QString::fromUtf8("restartAction"));
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icon/restart.ico"), QSize(), QIcon::Normal, QIcon::Off);
        restartAction->setIcon(icon6);
